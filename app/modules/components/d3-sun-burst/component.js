...
/**
 * Sun burst chart derived from http://bl.ocks.org/mbostock/4348373 and https://www.jasondavies.com/coffee-wheel/
 * */
export default Ember.Component.extend({
  ...
  draw(){
    ...
    var i = Ember.$("#moose-container").width() * 0.75,
      l = i,
      o = i / 2,
      ...
      path = null,
      text = null,
      container = d3.select("#" + this.get('elementId')),
      onClick = function (n) {
        path
          .transition()
          .duration(s)
